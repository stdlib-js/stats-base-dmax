...
```javascript
dmax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmax@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmax@umd/bundle.js"></script>
```
